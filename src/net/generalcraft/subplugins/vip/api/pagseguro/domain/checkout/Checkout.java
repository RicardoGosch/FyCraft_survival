...
package net.generalcraft.subplugins.vip.api.pagseguro.domain.checkout;
...
import net.generalcraft.subplugins.vip.api.pagseguro.domain.Address;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.Credentials;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.Item;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.MetaData;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.MetaDataItem;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.Parameter;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.ParameterItem;
...
import net.generalcraft.subplugins.vip.api.pagseguro.domain.SenderDocument;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.Shipping;
import net.generalcraft.subplugins.vip.api.pagseguro.enums.Currency;
import net.generalcraft.subplugins.vip.api.pagseguro.enums.DocumentType;
import net.generalcraft.subplugins.vip.api.pagseguro.enums.InvalidURL;
import net.generalcraft.subplugins.vip.api.pagseguro.enums.MetaDataItemKey;
import net.generalcraft.subplugins.vip.api.pagseguro.enums.ShippingType;
import net.generalcraft.subplugins.vip.api.pagseguro.exception.PagSeguroServiceException;
import net.generalcraft.subplugins.vip.api.pagseguro.service.checkout.CheckoutService;
