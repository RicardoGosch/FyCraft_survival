...
import net.generalcraft.subplugins.vip.api.pagseguro.domain.TransactionSearchResult;
import net.generalcraft.subplugins.vip.api.pagseguro.domain.TransactionSummary;
