package net.generalcraft.subplugins.vip.cmd;

//net.generalcraft.subplugins.vip.api.pagseguro
import org.bukkit.plugin.Plugin;

import net.generalcraft.subplugins.vip.api.pagseguro.domain.AccountCredentials;
