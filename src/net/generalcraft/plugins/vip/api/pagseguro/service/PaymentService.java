...
import net.generalcraft.plugins.vip.api.pagseguro.domain.PaymentRequest;
import net.generalcraft.plugins.vip.api.pagseguro.domain.checkout.Checkout;
...
import net.generalcraft.plugins.vip.api.pagseguro.parser.PaymentParser;
