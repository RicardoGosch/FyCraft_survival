...
package net.generalcraft.plugins.vip.api.pagseguro.service;

import java.net.HttpURLConnection;
import java.util.List;

import net.generalcraft.plugins.vip.api.pagseguro.domain.Authorization;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Credentials;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Error;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Transaction;
import net.generalcraft.plugins.vip.api.pagseguro.domain.paymentrequest.PaymentRequestTransaction;
import net.generalcraft.plugins.vip.api.pagseguro.enums.HttpStatus;
...
import net.generalcraft.plugins.vip.api.pagseguro.parser.TransactionParser;
import net.generalcraft.plugins.vip.api.pagseguro.parser.authorization.AuthorizationParser;
import net.generalcraft.plugins.vip.api.pagseguro.parser.paymentrequest.PaymentRequestParser;
import net.generalcraft.plugins.vip.api.pagseguro.properties.PagSeguroSystem;
import net.generalcraft.plugins.vip.api.pagseguro.utils.HttpConnection;
import net.generalcraft.plugins.vip.api.pagseguro.xmlparser.ErrorsParser;
