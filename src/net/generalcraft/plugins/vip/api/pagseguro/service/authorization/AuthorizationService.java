...
package net.generalcraft.plugins.vip.api.pagseguro.service.authorization;
...
import net.generalcraft.plugins.vip.api.pagseguro.parser.authorization.AuthorizationRequestParser;
...
public class AuthorizationService {
     ...
     * @throws Exception
     */
    public static String createAuthorizationRequest(Credentials credentials, net.generalcraft.plugins.vip.api.pagseguro.domain.authorization.AuthorizationRequest authorizationRequest, Boolean onlyCheckoutCode)
            throws PagSeguroServiceException {
