...
package net.generalcraft.plugins.vip.api.pagseguro.domain.checkout;
...
import net.generalcraft.plugins.vip.api.pagseguro.domain.Address;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Credentials;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Item;
import net.generalcraft.plugins.vip.api.pagseguro.domain.MetaData;
import net.generalcraft.plugins.vip.api.pagseguro.domain.MetaDataItem;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Parameter;
import net.generalcraft.plugins.vip.api.pagseguro.domain.ParameterItem;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Phone;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Sender;
import net.generalcraft.plugins.vip.api.pagseguro.domain.SenderDocument;
import net.generalcraft.plugins.vip.api.pagseguro.domain.Shipping;
import net.generalcraft.plugins.vip.api.pagseguro.enums.Currency;
import net.generalcraft.plugins.vip.api.pagseguro.enums.DocumentType;
import net.generalcraft.plugins.vip.api.pagseguro.enums.InvalidURL;
import net.generalcraft.plugins.vip.api.pagseguro.enums.MetaDataItemKey;
import net.generalcraft.plugins.vip.api.pagseguro.enums.ShippingType;
import net.generalcraft.plugins.vip.api.pagseguro.exception.PagSeguroServiceException;
import net.generalcraft.plugins.vip.api.pagseguro.service.checkout.CheckoutService;
