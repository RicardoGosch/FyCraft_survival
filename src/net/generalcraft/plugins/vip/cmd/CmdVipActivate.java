package net.generalcraft.plugins.vip.cmd;

//net.generalcraft.plugins.vip.api.pagseguro
import org.bukkit.plugin.Plugin;

import net.generalcraft.plugins.vip.api.pagseguro.domain.AccountCredentials;
...
import net.generalcraft.plugins.vip.model.ModelVIP;

public class CmdVipActivate {
