...
package net.merrycraft.subplugins.vip.api.pagseguro.domain.checkout;
...
import net.merrycraft.subplugins.vip.api.pagseguro.domain.Address;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.Credentials;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.Item;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.MetaData;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.MetaDataItem;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.Parameter;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.ParameterItem;
...
import net.merrycraft.subplugins.vip.api.pagseguro.domain.SenderDocument;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.Shipping;
import net.merrycraft.subplugins.vip.api.pagseguro.enums.Currency;
import net.merrycraft.subplugins.vip.api.pagseguro.enums.DocumentType;
import net.merrycraft.subplugins.vip.api.pagseguro.enums.InvalidURL;
import net.merrycraft.subplugins.vip.api.pagseguro.enums.MetaDataItemKey;
import net.merrycraft.subplugins.vip.api.pagseguro.enums.ShippingType;
import net.merrycraft.subplugins.vip.api.pagseguro.exception.PagSeguroServiceException;
import net.merrycraft.subplugins.vip.api.pagseguro.service.checkout.CheckoutService;
