...
import net.merrycraft.subplugins.vip.api.pagseguro.domain.TransactionSearchResult;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.TransactionSummary;
