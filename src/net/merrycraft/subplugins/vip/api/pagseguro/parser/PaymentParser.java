...
import net.merrycraft.subplugins.vip.api.pagseguro.domain.PaymentRequest;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.SenderDocument;
import net.merrycraft.subplugins.vip.api.pagseguro.domain.checkout.Checkout;
import net.merrycraft.subplugins.vip.api.pagseguro.parser.checkout.CheckoutParser;
