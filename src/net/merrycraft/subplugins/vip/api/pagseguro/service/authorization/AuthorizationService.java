...
package net.merrycraft.subplugins.vip.api.pagseguro.service.authorization;
...
import net.merrycraft.subplugins.vip.api.pagseguro.parser.authorization.AuthorizationRequestParser;
...
public class AuthorizationService {
     ...
     * @throws Exception
     */
    public static String createAuthorizationRequest(Credentials credentials, net.merrycraft.subplugins.vip.api.pagseguro.domain.authorization.AuthorizationRequest authorizationRequest, Boolean onlyCheckoutCode)
            throws PagSeguroServiceException {
