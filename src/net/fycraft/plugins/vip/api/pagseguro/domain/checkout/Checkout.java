...
package net.fycraft.plugins.vip.api.pagseguro.domain.checkout;
...
import net.fycraft.plugins.vip.api.pagseguro.domain.Address;
import net.fycraft.plugins.vip.api.pagseguro.domain.Credentials;
import net.fycraft.plugins.vip.api.pagseguro.domain.Item;
import net.fycraft.plugins.vip.api.pagseguro.domain.MetaData;
import net.fycraft.plugins.vip.api.pagseguro.domain.MetaDataItem;
import net.fycraft.plugins.vip.api.pagseguro.domain.Parameter;
import net.fycraft.plugins.vip.api.pagseguro.domain.ParameterItem;
import net.fycraft.plugins.vip.api.pagseguro.domain.Phone;
import net.fycraft.plugins.vip.api.pagseguro.domain.Sender;
import net.fycraft.plugins.vip.api.pagseguro.domain.SenderDocument;
import net.fycraft.plugins.vip.api.pagseguro.domain.Shipping;
import net.fycraft.plugins.vip.api.pagseguro.enums.Currency;
import net.fycraft.plugins.vip.api.pagseguro.enums.DocumentType;
import net.fycraft.plugins.vip.api.pagseguro.enums.InvalidURL;
import net.fycraft.plugins.vip.api.pagseguro.enums.MetaDataItemKey;
import net.fycraft.plugins.vip.api.pagseguro.enums.ShippingType;
