...
package net.fycraft.plugins.vip.api.pagseguro.domain.direct.checkout;
...
import net.fycraft.plugins.vip.api.pagseguro.domain.Commission;
...
import net.fycraft.plugins.vip.api.pagseguro.enums.PaymentMode;
