...
package net.fycraft.plugins.vip.api.pagseguro.service.authorization;
...
import net.fycraft.plugins.vip.api.pagseguro.parser.authorization.AuthorizationRequestParser;
...
public class AuthorizationService {
     ...
     * @throws Exception
     */
    public static String createAuthorizationRequest(Credentials credentials, net.fycraft.plugins.vip.api.pagseguro.domain.authorization.AuthorizationRequest authorizationRequest, Boolean onlyCheckoutCode)
            throws PagSeguroServiceException {
